...
public class Game2048LayoutNew extends RelativeLayout {
    ...
    public Game2048LayoutNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    public Game2048LayoutNew(Context context) {
        this(context, null);
    }

    public Game2048LayoutNew(Context context, AttributeSet attrs) {
