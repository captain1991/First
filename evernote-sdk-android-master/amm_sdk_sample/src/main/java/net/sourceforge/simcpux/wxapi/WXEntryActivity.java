...
import com.xiaodong.tu8me.IMyAidlInterface;

import net.sourceforge.simcpux.AxisActivity;
import net.sourceforge.simcpux.AxisActivityNew;
...
//		bindService(intent,conn, Service.BIND_AUTO_CREATE);
    	...
    	regBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(WXEntryActivity.this, AxisActivityNew.class));
...
//		        finish();
				startActivity(new Intent(WXEntryActivity.this, AxisActivity.class));
//				try {
